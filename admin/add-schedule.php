...
if(isset($_POST['add_schedule']))
{
 $team1=$_POST['team1'];
 $team2=$_POST['team2'];
 $scdate=$_POST['month'].' '. $_POST['day'].' '. $_POST['year'];
 $mode=$_POST['mode'];
 $schedule_query = "Insert into schedule VALUES('','$team1','$team2','$scdate','','$mode')";
 $query_run=mysqli_query($con,$schedule_query);
 if(!$query_run){
 	$match = '<div class="alert alert-danger">There is a problem in adding your schedule, Please try later.</div>';
 }else{
 	$match ='<div class="alert alert-success">Your Schedule Added Sucessfully.</div>';
...
<body>
	...
	<div class="row">
            ...
            <option value="">Year</option>
                    ...
                    <select class="form-control" style="max-width:30%;" name="mode" id="mode" require>
                            <option value="">Type</option>
                            <option  value="t20">T20</option>
                            <option  value="regular 35overs">Regular 35 overs Match</option>
                    </select>
                     </div>
			     <div class="form-group">
